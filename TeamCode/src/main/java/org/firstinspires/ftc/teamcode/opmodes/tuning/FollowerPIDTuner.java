...
public class FollowerPIDTuner extends LinearOpMode implements DogeOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (!isStopRequested()) {
            ...
            commander.runCommand(new DriveTurn(drivetrain, Math.toRadians(90)));

            startPose = trajectory.end().plus(new Pose2d(0, 0, Math.toRadians(90)));
        }
    }
}
